...
str_layout.markdown("""
    ...
    div[data-testid="stMetricValue"] { font-weight: 700; color: #3B82F6; }
    </style>
...
if trigger_scan:
    if API_KEY == "YOUR_GOOGLE_API_KEY_HERE":
        str_layout.error("Configuration Error: Please assign a valid Google API key inside 'app.py' line 11.")
    else:
        with str_layout.spinner("Connecting to YouTube Data API v3 and processing baseline ratios..."):
            try:
                ...
                if compiled_results:
                    ...
                    str_layout.warning("No anomalies detected matching this exact performance threshold. Try expanding search query parameters or lowering the performance slider.")
            except Exception as system_error:
                str_layout.error(f"System Execution Exception: {str(system_error)}")